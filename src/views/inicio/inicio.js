    ...
    view: () => {
        return [
            ...
            m("div.page-wrapper", [
                m("header.header",
                    m("div.header__inner",
                        m("div.container-fluid",
                            m("div.header__row.row.justify-content-between", [
                                m("div.header__col-left.col.d-flex.align-items-center", [
                                    m("div.header__left-toggle", [
                                        ...
                                        m("button.header__toggle-search.toggle-search",
                                            m("img.sidebar__logo-icon[src='arion/img/isotipo.png'][alt='#'][width='44']", {
                                ...
                                m("div.header__col-right.col.d-flex.align-items-center", [


                                    m("div.header__profile.dropdown", {
                                        style: { "margin-left": "auto" }
                                    }, [
                                        m("a.header__profile-toggle.dropdown__toggle[href='#'][data-toggle='dropdown']", [
                                            m("div.header__profile-image", [
                                                m("span.header__profile-image-text",
                                                    "MA"
                                                ),
                                            ]),
                                            m("div.header__profile-text",
                                                m("span",
                                                    "Mark Anderson"
                                                )
                                            ),
                                            m("span.icon-arrow-down",
                                                m("svg.icon-icon-arrow-down",
                                                    m("use[xlink:href='#icon-arrow-down']")
                                                )
                                            )
                                        ]),
                                        m("div.profile-dropdown.dropdown-menu.dropdown-menu--right", [
                                            m("a.profile-dropdown__item.dropdown-menu__item[href='#'][tabindex='0']", [
                                                m("span.profile-dropdown__icon",
                                                    m("svg.icon-icon-user",
                                                        m("use[xlink:href='#icon-user']")
                                                    )
                                                ),
                                                m("span",
                                                    "Mi Perfil"
                                            ...
                                            m("div.dropdown-menu__divider"),
                                            m("a.profile-dropdown__item.dropdown-menu__item[href='/salir'][tabindex='0']", [
                                                m("span.profile-dropdown__icon",
                                                    m("svg.icon-icon-logout",
                                                        m("use[xlink:href='#icon-logout']")
                                                    )
                                                ),
                                                m("span",
                                                    "Salir"
                ...
                m("aside.sidebar", [
                    m("div.sidebar__backdrop"),
                    m("div.sidebar__container", [
                        m("div.sidebar__top",
                            m("div.container.container--sm",
                                m("a.sidebar__logo[href='/']", [
                                    m("img.sidebar__logo-icon[src='arion/img/isotipo.png'][alt='#'][width='44']", {
                                        style: { "min-width": "2rem" }
                                    }),
                                    m("div.sidebar__logo-text", {
                        ...
                        m(".sidebar__content[data-simplebar='data-simplebar']",
                            m("nav.sidebar__nav",
                                m("ul.sidebar__menu", [

                                    m("li.sidebar__menu-item",
                                        m("a.sidebar__link.active[href='/'][aria-expanded='true']", [
                                            m("span.sidebar__link-icon",
                                                m("svg.icon-icon-email",
                                                    m("use[xlink:href='#icon-dashboard']")
                                                )
                                            ),
                                            m("span.sidebar__link-text",
                                                "Mis Pacientes"
                                            ),
                ...
                m("main.page-content.page-content--full",
                    m("div.inbox-grid", [
                        m("aside.sidebar-panel.scrollbar-thin[id='sidebarPanel'][data-simplebar='data-simplebar']", [

                            m("div.sidebar-panel__content", [
                                m("div.sidebar-panel__nav",
                                    m("ul.sidebar-panel__menu", [
                                        m("li.sidebar-panel__menu-item",
                                            m("a.sidebar-panel__menu-link.active[href='#']", [
                                                m("svg.icon-icon-inbox",
                                                    m("use[xlink:href='#icon-inbox']")
                                                ),
                                                m("span.sidebar-panel__menu-text",
                                                    "Pendientes"
                                                ),
                                                m("span.badge.badge--red",
                                                    "20"
                                                )
                                            ])
                                        ),
                                        m("li.sidebar-panel__menu-item",
                                            m("a.sidebar-panel__menu-link[href='#']", [
                                                m("svg.icon-icon-send",
                                                    m("use[xlink:href='#icon-send']")
                                                ),
                                                m("span.sidebar-panel__menu-text",
                                                    "Gestionados"
                                                )
                                        ...
                                        m("li.sidebar-panel__menu-item",
                                            m("a.sidebar-panel__menu-link[href='#']", [
                                                m("svg.icon-icon-drafts",
                                                    m("use[xlink:href='#icon-drafts']")
                                                ),
                                                m("span.sidebar-panel__menu-text",
                                                    "Atendidos"
                                                ),
                        ...
                        m("div.inbox-mails", [
                            m("div.inbox-mails__top", [
                                m("button.toggle-sidebar.toggle-sidebar--secondary.js-toggle-sidebar-panel[type='button'][data-toggle='#sidebarPanel']",
                                    m("svg.icon-icon-menu",
                                        m("use[xlink:href='#icon-menu']")
                                    )
                                ),
                                m("button.toggle-search.toggle-search--module[type='button'][data-search='#search0']", [
                                    m("svg.icon-icon-search",
                                        m("use[xlink:href='#icon-search']")
                                    ),
                                    m("svg.icon-icon-cross",
                                        m("use[xlink:href='#icon-cross']")
                                    )
                                ]),
                                m("form.module-search[id='search0'][method='GET']",
                                    m("div.input-group.input-group--prepend", [
                                        m("div.input-group__prepend",
                                            m("svg.icon-icon-search",
                                                m("use[xlink:href='#icon-search']")
                                            )
                                        ),
                                ...
                                m("div.inbox-mails__sort", [
                                    m("span.text-light-theme.mr-1",
                                        "Sort by:"
                                    ),
                                    m("button.inbox-mails__sort-button.text-dark-theme[type='button'][data-toggle='dropdown']", [
                                        m("span.inbox-mails__sort-text",
                                            "Date"
                                        ),
                                        m("span.inbox-mails__sort-arrow",
                                            m("svg.icon-icon-arrow-down",
                                                m("use[xlink:href='#icon-arrow-down']")
                                            )
                                        )
                                    ]),
                                    m("div.dropdown-menu.dropdown-menu--right.js-dropdown-select", [
                                        m("a.dropdown-menu__item.active[href='#'][tabindex='0'][data-value='Date']", [
                                            m("span.marker-item"),
                                            " Date"
                                        ]),
                                        m("a.dropdown-menu__item[href='#'][tabindex='0'][data-value='Personal']", [
                                            m("span.marker-item.color-red"),
                                            " Personal"
                                        ]),
                                        m("a.dropdown-menu__item[href='#'][tabindex='0'][data-value='Clients']", [
                                            m("span.marker-item.color-teal"),
                                            " Clients"
                                        ]),
                                        m("a.dropdown-menu__item.active[href='#'][tabindex='0'][data-value='Events']", [
                                            m("span.marker-item.color-green"),
                                            " Events"
                                        ]),
                                        m("a.dropdown-menu__item[href='#'][tabindex='0'][data-value='Social']", [
                                            m("span.marker-item.color-orange"),
                                            " Social"
                                        ]),
                                        m("a.dropdown-menu__item[href='#'][tabindex='0'][data-value='Work']", [
                                            m("span.marker-item.color-grey-light"),
                                            " Work"
                                        ])
                                    ])
                                ])
                            ]),
                            m(".inbox-mails__content.scrollbar-thin.scrollbar-hidden[data-simplebar='']",
                                m("ul.inbox-mails__list", [
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-orange-dark", [
                                                m("div.inbox-mails__item-avatar-text",
                                                    "FB"
                                                ),
                                                m("img[src='img/content/humans/item-1.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name", [
                                                    m("span",
                                                        "Felecia Burke"
                                                    ),
                                                    m("span.marker-item.color-red")
                                                ]),
                                                m("div.inbox-mails__item-right-group", [
                                                    m("span.inbox-mails__item-attachment",
                                                        m("svg.icon-icon-attachment",
                                                            m("use[xlink:href='#icon-attachment']")
                                                        )
                                                    ),
                                                    m("span.inbox-mails__item-time",
                                                        "20 min"
                                                    )
                                                ]),
                                                m("div.inbox-mails__item-message",
                                                    m("p.inbox-mails__item-text",
                                                        "The Arts play a large role in the expression of inner thoughts and beauty in my life. The Arts play a large role in the expression of inner thoughts and beauty in my life"
                                                    )
                                                )
                                            ])
                                        ])
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item.active[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-red", [
                                                m("div.inbox-mails__item-avatar-text",
                                                    "JB"
                                                ),
                                                m("img[src='img/content/humans/item-4.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name", [
                                                    m("span",
                                                ...
                                                m("div.inbox-mails__item-message", [
                                                    ...
                                                    m("p.inbox-mails__item-text",
                                                        "I am writing to introduce you to David Boyd"
                                                    )
                                                ])
                                            ])
                                        ])
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-teal", [
                                                m("div.inbox-mails__item-avatar-text",
                                                    "DP"
                                                ),
                                                m("img[src='img/content/humans/item-5.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name",
                                                    m("span",
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-orange", [
                                                m("div.inbox-mails__item-avatar-text",
                                                    "ED"
                                                ),
                                                m("img[src='img/content/humans/item-2.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name",
                                                    m("span",
                                                ...
                                                m("div.inbox-mails__item-message",
                                                    m("p.inbox-mails__item-text",
                                                        "The arts allow us to be as specific or as abstract as we please. It helps us become closer"
                                                    )
                                                )
                                            ])
                                        ])
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-green", [
                                                m("div.inbox-mails__item-avatar-text",
                                                    "MS"
                                                ),
                                                m("img[src='img/content/humans/item-6.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name",
                                                    m("span",
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-orange-dark", [
                                                ...
                                                m("img[src='img/content/humans/item-7.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name", [
                                                    m("span",
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-teal", [
                                                ...
                                                m("img[src='img/content/humans/item-8.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name",
                                                    m("span",
                                                ...
                                                m("div.inbox-mails__item-message",
                                                    m("p.inbox-mails__item-text",
                                                        "Music, singing, dancing, poetry, and sketching are just a few of the different forms of"
                                                    )
                                                )
                                            ])
                                        ])
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-red", [
                                                ...
                                                m("img[src='img/content/humans/item-3.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name", [
                                                    m("span",
                                                ...
                                                m("div.inbox-mails__item-message",
                                                    m("p.inbox-mails__item-text",
                                                        "Prepare us to adapt to and respect the ways others think, work, and express themselves"
                                                    )
                                                )
                                            ])
                                        ])
                                    ...
                                    m("li.inbox-mails__list-item",
                                        m("a.inbox-mails__item[href='#']", [
                                            m("div.inbox-mails__item-avatar.color-orange", [
                                                ...
                                                m("img[src='img/content/humans/item-9.jpg'][alt='#']")
                                            ]),
                                            m("div.inbox-mails__item-right", [
                                                m("h5.inbox-mails__item-name",
                                                    m("span",
                                                ...
                                                m("div.inbox-mails__item-message",
                                                    m("p.inbox-mails__item-text",
                                                        "Show us how to understand human experiences, past and present"
                                                    )
                                                )
                                            ])
                                        ])
                        ...
                        m("div.inbox-details", [
                            m("div.inbox-details__top", [
                                m("div.inbox-details__top-left", [
                                    m("button.inbox-details__dismiss.button-icon.button-icon--grey[type='button'][data-dismiss=''][data-tippy-content='Back to']",
                                        m("span.button-icon__icon",
                                            m("svg.icon-icon-chevron",
                                                m("use[xlink:href='#icon-chevron']")
                                            )
                                        )
                                    ),
                                    m("div.d-sm-inline-flex",
                                        m("button.button-icon.button-icon--invisible.button-icon--grey[data-tippy-content='Reply All'][data-tippy-placement='bottom']",
                                            m("span.button-icon__icon",
                                                m("svg.icon-icon-reply-all",
                                                    m("use[xlink:href='#icon-reply-all']")
                                                )
                                            )
                                        )
                                    ),
                                    m("div.d-sm-inline-flex",
                                        m("button.button-icon.button-icon--invisible.button-icon--grey[data-tippy-content='Reply'][data-tippy-placement='bottom']",
                                            m("span.button-icon__icon",
                                                m("svg.icon-icon-reply",
                                                    m("use[xlink:href='#icon-reply']")
                                                )
                                            )
                                        )
                                    )
                                ]),
                                m("div.inbox-details__pagination", [
                                    m("button.button-icon.button-icon--grey[data-tippy-content='Previous'][data-tippy-placement='bottom']",
                                        m("span.button-icon__icon",
                                            m("svg.icon-icon-keyboard-left",
                                                m("use[xlink:href='#icon-keyboard-left']")
                                            )
                                        )
                                    ),
                                    m("div.d-inline-flex.align-items-center.mx-2", [
                                        m("span",
                                            "1"
                                        ),
                                        m("span.mx-1",
                                    ...
                                    m("button.button-icon.button-icon--grey[data-tippy-content='Next'][data-tippy-placement='bottom']",
                                        m("span.button-icon__icon",
                                            m("svg.icon-icon-keyboard-right",
                                                m("use[xlink:href='#icon-keyboard-right']")
                                            )
                                        )
                                    )
                                ]),
                                m("div.inbox-details__top-right", [
                                    m("button.button-icon.button-icon--grey[data-tippy-content='Save'][data-tippy-placement='bottom']",
                                        m("span.button-icon__icon",
                                            m("svg.icon-icon-flag",
                                                m("use[xlink:href='#icon-flag']")
                                            )
                                        )
                                    ),
                                    m("div.d-none.d-sm-inline-flex",
                                        m("button.button-icon.button-icon--grey[data-tippy-content='Print'][data-tippy-placement='bottom']",
                                            m("span.button-icon__icon",
                                                m("svg.icon-icon-print",
                                                    m("use[xlink:href='#icon-print']")
                                                )
                                            )
                                        )
                                    ),
                                    m("div.d-inline-flex",
                                        m("button.button-icon.button-icon--grey[data-tippy-content='Delete'][data-tippy-placement='bottom']",
                                            m("span.button-icon__icon",
                                                m("svg.icon-icon-trash",
                                                    m("use[xlink:href='#icon-trash']")
                                                )
                                            )
                                        )
                                    )
                            ...
                            m(".inbox-details__content.scrollbar-thin.scrollbar-hidden[data-simplebar='']", [
                                m("div.inbox-details__header", [
                                    m("div.media-item.media-item--medium", [
                                        m("div.media-item__icon.color-red", [
                                            m("div.media-item__icon-text",
                                                "JB"
                                            ),
                                            m("img.media-item__thumb[src='img/content/humans/item-4.jpg'][alt='#']")
                                        ]),
                                        m("div.media-item__right", [
                                            m("h5.media-item__title",
                                                "Joan Bates"
                                            ),
                                            m("a.text-sm.text-blue[href='mailto:#']",
                                                "david_boyd@mail.com"
                                            )
                                        ])
                                    ]),
                                    m("div.text-nowrap.text-sm.text-grey",
                                        "30 Nov 2019"
                                    )
                                ]),
                                m("pre.inbox-details__text-message", [
                                    m("div", [
                                        m("div",
                                            "Hello, Mark!"
                                        ),
                                    ...
                                    m("a.text-blue[href='mailto']",
                                        "david_boyd@mail.com"
                                    ),
                                    " Thanks for any help you can give. ",
                                    m("img[src='img/content/emoji-happy.svg'][alt='#']"),
                                    m("div", [
                                        m("div",
                                            "Best regards,"
                                        ),
                                ...
                                m("div.inbox-details__files", [
                                    m("div.media-file", [
                                        m("div.media-file__icon",
                                            m("img.media-file__thumb[src='img/content/file-pdf.svg'][alt='#']")
                                        ),
                                        m("div.media-file__right", [
                                            m("div.media-file__prepend", [
                                                m("h5.media-file__title",
                                                    "Resume.pdf"
                                                ),
                                                m("span.text-sm.text-grey",
                                                    "570 KB"
                                                )
                                            ]),
                                            m("div.media-file__append",
                                                m("a.button-icon.button-icon--grey[href='#']",
                                                    m("span.button-icon__icon",
                                                        m("svg.icon-icon-download",
                                                            m("use[xlink:href='#icon-download']")
                                                        )
                                                    )
                                                )
                                            )
                                    ...
                                    m("div.media-file", [
                                        m("div.media-file__icon",
                                            m("img.media-file__thumb[src='img/content/file-zip.svg'][alt='#']")
                                        ),
                                        m("div.media-file__right", [
                                            m("div.media-file__prepend", [
                                                m("h5.media-file__title",
                                ...
                                m("div.inbox-details__input",
                                    m("textarea.input[rows='4'][placeholder='Reply...']")
                                )
                            ]),
                            m("div.inbox-details__bottom",
                                m("div.row", [
                                    m("div.col-auto", [
                                        m("label.button-icon.button-icon--transparent", [
                                        ...
                                        m("div.inbox-details__emoji.position-relative", [
                                            m("button.button-icon.button-icon--transparent[data-toggle='dropdown']",
                                                m("span.button-icon__icon",
                                                    m("svg.icon-icon-emoji",
                                                        m("use[xlink:href='#icon-emoji']")
                                                    )
                                                )
                                            ),
                                            m("div.dropdown-emoji.dropdown-menu.dropdown-menu--up",
                                                m("div.dropdown-emoji__content", [
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/laughing.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/happy-2.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/crazy.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/bad.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/angry.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/happy.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/thinking.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/sad.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/pressure.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/in-love.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/nerd.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/happy-3.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/shocked.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/wink.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/sweating.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/shocked-2.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/shocked-3.svg'][alt='#']")
                                                    ),
                                                    m("a.dropdown-emoji__item[href='#'][tabindex='0']",
                                                        m("img.dropdown-emoji__image[src='img/content/emoji/sad-2.svg'][alt='#']")
                                                    )
                                                ])
                                            )
                                        ])
                                    ]),
                                    m("div.col-auto.ml-auto",
                                        m("button.button.button--primary", [
                                            m("span.button__icon.button__icon--left",
                                                m("svg.icon-icon-reply",
                                                    m("use[xlink:href='#icon-reply']")
                                                )
                                            ),
